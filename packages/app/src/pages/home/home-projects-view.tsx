...
export type HomeProjectsViewProps = {
  ...
  onManageProjectDirectories: (server: ServerConnection.Any, project: LocalProject) => void
        ...
        >
          ...
          <MenuV2.Portal>
            <MenuV2.Content>
              ...
              <MenuV2.Item onSelect={() => props.onManageProjectDirectories(props.server, props.project)}>
                {props.language.t("home.project.manageDirectories")}
              </MenuV2.Item>
