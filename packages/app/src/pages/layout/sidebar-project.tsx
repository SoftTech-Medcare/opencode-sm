...
export type ProjectSidebarContext = {
  ...
  showProjectDirectoriesDialog: (project: LocalProject) => void
    ...
    >
      ...
      <ContextMenu.Portal>
        <ContextMenu.Content>
          ...
          <ContextMenu.Item
            data-action="project-manage-directories"
            onSelect={() => props.showProjectDirectoriesDialog(props.project)}
          >
            <ContextMenu.ItemLabel>{props.language.t("sidebar.project.manageDirectories")}</ContextMenu.ItemLabel>
          </ContextMenu.Item>
          <ContextMenu.Item
  ...
  const tile = () => (
    <ProjectTile
      ...
      navigateToProject={props.ctx.navigateToProject}
       ...
       showProjectDirectoriesDialog={props.ctx.showProjectDirectoriesDialog}
