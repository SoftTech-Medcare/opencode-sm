...
export const dict = {
  ...
  "dialog.project.directories.noMatch": "No directories match {{query}}.",
  "dialog.project.directories.mainFolder": "Main folder",
  "dialog.project.directories.mainNote": "Sessions start here by default",
  "dialog.project.directories.makeMain": "Make main",
  "dialog.project.directories.additional": "Additional folders ({{count}})",
  "dialog.project.directories.filter": "Filter directories",
